  ...
  <div class="container mx-auto">
    <div>
      <el-form >
        ...
        <div class="ml-5">
          <el-form-item label="待处置的车子" class="w-1/2 mx-auto">
            <el-select v-model="childNum" placeholder="车子" size="small" @change="childList(childNum)">
        ...
        <div class="ml-5">
          ...
          <div >
            ...
            <div v-for="(item,index) in childAll" :key="index">
              <h2 class="text-left my-5 border-b pb-5 text-base text-orange-500">车子{{index+1}}</h2>
              <!-- 大问题块 -->
              ...
              <div class="text-right flex">
                <div class="ml-1 mb-3 py-1 text-base text-blue-500 px-1 rounded border border-1 hover:bg-orange-500 hover:text-white cursor-pointer" @click="removeFangChan(index)">删除当前车子</div>
              </div>
            </div>
            <div class="text-right flex">
              <div class="ml-1 mb-3 py-1 text-base text-blue-500 px-1 rounded border border-1 hover:bg-green-500 hover:text-white cursor-pointer" @click="addFangChan">添加车子</div>
            </div>
          </div>
        </div>
      </el-form>
    ...
    components: {
      ...
      methods: {
        ...
        addFangChan () {
          ...
          alert('添加第'+this.childAll.length+'车子')
        },
        removeFangChan (index) {
          this.childAll.splice(index,1)
          alert('删除第'+(index+1)+'车子')
        },
        UpPage () {
          this.$router.replace("/CunKuan");
        },
        NextPage () {
          this.$router.replace("/LiCai");
        },
        addChildBirthday1 (e) {
