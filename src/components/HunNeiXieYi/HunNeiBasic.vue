                            ...
                            <div v-if="$$item.type == 'radio'">
                              ...
                              <div v-if="$$item.childQuestion  && $$item.childQuestion[$$item.answer]">
                                <div v-for="($$$item,$$$index) in $$item.childQuestion[$$item.answer]" :key="$$$index">
                                  <div v-show="!$$$item.requireQidAndAnswer || ($$$item.requireQidAndAnswer && $$item.childQuestion[$$item.answer].filter(filterItme=>{return filterItme.id == $$$item.requireQidAndAnswer.id})[0] && $$item.childQuestion[$$item.answer].filter(filterItme=>{return filterItme.id == $$$item.requireQidAndAnswer.id})[0].answer == $$$item.requireQidAndAnswer.answer)">
                                    <!-- 数字 -->
                                    <div v-if="$$$item.type == 'input' && $$$item.input_type=='number'">
                                      <el-form-item label="" class="text-base">
                                        <div>
                                      ...
                                      <div v-if="$$$item.grandson">
                                        <div v-for="($$$$item, $$$$index) in $$$item.answer" :key="$$$$index">
                                          <div v-for="($$$$$item,$$$$$index) in $$$item.grandson[$$$$item]" :key="$$$$$index">
                                            <div v-show="!$$$$$item.requireQidAndAnswer || ($$$$$item.requireQidAndAnswer && $$$item.grandson[$$$$item].filter(filterItme=>{return filterItme.id == $$$$$item.requireQidAndAnswer.id})[0] && $$$item.grandson[$$$$item].filter(filterItme=>{return filterItme.id == $$$$$item.requireQidAndAnswer.id})[0].answer == $$$$$item.requireQidAndAnswer.answer)">
                                              <!-- 数字类型输入框 -->
                                              <div v-if="$$$$$item.type == 'input' && $$$$$item.input_type=='number'">
                                                <el-form-item label="" class="text-base">
                                                  <div>
                                    ...
                                    <div v-if="$$$item.type == 'radio'">
                                      ...
                                      <div v-if="$$$item.grandson">
                                        <div v-for="($$$$item,$$$$index) in $$$item.grandson[$$$item.answer]" :key="$$$$index">
                                          <div v-show="!$$$$item.requireQidAndAnswer || ($$$$item.requireQidAndAnswer && $$$item.grandson[$$$item.answer].filter(filterItme=>{return filterItme.id == $$$$item.requireQidAndAnswer.id})[0] && $$$item.grandson[$$$item.answer].filter(filterItme=>{return filterItme.id == $$$$item.requireQidAndAnswer.id})[0].answer == $$$$item.requireQidAndAnswer.answer)">
                                            <!-- 数字 -->
                                            <div v-if="$$$$item.type == 'input' && $$$$item.input_type=='number'">
                                              <el-form-item label="" class="text-base">
                                                <div>
                              ...
                              <div v-if="$$item.childQuestion">
                                <div v-for="($$$item, $$$index) in $$item.answer" :key="$$$index">
                                  <div v-for="($$$$item,$$$$index) in $$item.childQuestion[$$$item]" :key="$$$$index+$$$item">
                                    <div v-show="!$$$$item.requireQidAndAnswer || ($$$$item.requireQidAndAnswer && $$item.childQuestion[$$$item].filter(filterItme=>{return filterItme.id == $$$$item.requireQidAndAnswer.id})[0] && $$item.childQuestion[$$$item].filter(filterItme=>{return filterItme.id == $$$$item.requireQidAndAnswer.id})[0].answer == $$$$item.requireQidAndAnswer.answer)">
                                      <!-- 数字类型输入框 -->
                                      <div v-if="$$$$item.type == 'input' && $$$$item.input_type=='number'">
                                        <el-form-item label="" class="text-base">
                                          <div>
