  ...
  <div class="container mx-auto">
    <div>
      <el-form >
        ...
        <div class="ml-5">
          <el-form-item label="存款信息" class="w-1/2 mx-auto">
            <el-select v-model="childNum" placeholder="存款" size="small" @change="childList(childNum)">
        ...
        <div class="ml-5">
          ...
          <div >
            ...
            <div v-for="(item,index) in childAll" :key="index">
              <h2 class="text-left my-5 border-b pb-5 text-base text-orange-500">存款{{index+1}}</h2>
              <!-- 大问题块 -->
              ...
              <div class="text-right flex">
                <div class="ml-1 mb-3 py-1 text-base text-blue-500 px-1 rounded border border-1 hover:bg-orange-500 hover:text-white cursor-pointer" @click="removeFangChan(index)">删除当前存款</div>
              </div>
            </div>
            <div class="text-right flex">
              <div class="ml-1 mb-3 py-1 text-base text-blue-500 px-1 rounded border border-1 hover:bg-green-500 hover:text-white cursor-pointer" @click="addFangChan">添加存款</div>
            </div>
          </div>
        </div>
      </el-form>
